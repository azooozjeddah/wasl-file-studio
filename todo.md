...
- [ ] Remove the CSV `sep=,` directive because the tested Excel build reads the BOM-only fixture correctly but garbles the otherwise equivalent directive-based output.
