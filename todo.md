...
- [ ] توحيد تأثير خلفية الهيدر العلوي والسفلي بنفس البنفسجي والشفافية وbackdrop-blur، مع Safety Check ونشر واحد فقط بعد الموافقة.
- [ ] إنشاء والتحقق من checkpoint احتياطي لمصدر المشروع والإعدادات غير الحساسة فقط، مع استبعاد محتوى المستخدم وقاعدة البيانات والأسرار.
- [ ] فحص Push من local main إلى github/main قراءةً فقط عبر علاقة السلف وgit push --dry-run دون تنفيذ Push.
- [ ] تنفيذ Push fast-forward من local main إلى github/main فقط والتحقق من تطابق SHA، دون staging أو commit لـtodo.md ودون نشر.
- [ ] نشر النسخة المتزامنة من main عند ae58be6 والتحقق من الرابط والـSHA والتحذيرات دون عمليات Git إضافية.
