...
- [ ] PDF إلى Word فقط: اختيار PDF عربي حقيقي متعدد الصفحات والتحقق مسبقًا من أن طبقته النصية Unicode سليمة وقابلة للاستخراج.
- [ ] PDF إلى Word فقط: اختبار الرفع والتحويل والتنزيل من Production وفتح DOCX لفحص RTL والنص والصفحات وعدم الفقد أو التكرار.
- [ ] PDF إلى Word فقط: إعادة اختبار المسار على الجوال والتحقق من QR دون تعديلها، ثم تثبيت Ready أو إبقاء Maintenance وفق النتيجة.
- [ ] PDF إلى Word فقط: إضافة اتجاه RTL صحيح إلى فقرات DOCX العربية ثم إعادة قبول التقرير العربي الرسمي متعدد الصفحات من Production والجوال.
