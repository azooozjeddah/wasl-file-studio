...
- [ ] تثبيت مسار بناء ونشر قابل للتحقق مع بصمة إصدار عامة وسياسة cache-busting وخطة رجوع مستقرة دون تغيير أدوات منفردة.
- [x] إضافة حواجز regression وإجراءات اعتماد Ready للمسارات المشتركة، مع توثيق أثر أي تغيير مشترك قبل إصلاح أداة جديدة.
- [ ] توثيق GitHub ونسخة الرجوع والنسخ الاحتياطية ولوحة إدارة دورة الحياة، ثم التحقق النهائي وتسليم تقرير الأساس المستقر.
