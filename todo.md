...
- [ ] OCR فقط: إعادة تقييم أفضل بديل محلي في مختبر معزول وبنفس عينات النثر والجداول والصفحات المتعددة والجوال.
- [ ] OCR فقط: مقارنة Before/After وتحديد ما إذا كان المحرك البديل يحقق عتبة اعتماد متكررة قبل أي دمج أو تغيير حالة.
