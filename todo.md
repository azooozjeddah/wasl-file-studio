...
- [ ] PDF إلى Word فقط: اختبار PDF عربي حقيقي والتحقق من قابلية قراءة النص العربي داخل DOCX والتنزيل من Production والجوال.
- [ ] PDF إلى Word فقط: التحقق من بقاء QR Ready وعاملة، ثم تثبيت اعتماد PDF إلى Word النهائي في checkpoint وGitHub دون لمس أدوات أخرى.
