...
- [ ] OCR فقط: حفظ Baseline قابل للرجوع ثم تحديد محرك OCR والمكتبات والتحميلات والعمال وسبب ضعف العربية دون تعديل أدوات أخرى.
- [ ] OCR فقط: تجهيز عينات عربية وإنجليزية حقيقية واضحة وملف متعدد الصفحات مع النص المرجعي، وقياس CER/WER مقارنة بالنص الأصلي.
- [ ] OCR فقط: اختبار الرفع والمعالجة والتنزيل من Production والجوال، ثم إصلاح المحرك الحالي أو بديله المحلي فقط إن أثبت القياس الحاجة.
- [ ] OCR فقط: تثبيت Ready فقط عند معيار دقة موثق وثابت، أو إبقاؤه Maintenance مع سبب دقيق ومرجع checkpoint/commit.
