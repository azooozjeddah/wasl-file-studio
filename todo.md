...
- [ ] PDF إلى Word فقط: اختبار PDF حقيقي متعدد الصفحات والتأكد من حفظ كل الصفحات والنصوص في DOCX الناتج.
...
- [ ] PDF إلى Word فقط: منع إنشاء DOCX غير مقروء عندما يعيد PDF محارف مشوهة بلا ترميز Unicode عربي، ثم إعادة اختبار العربية والمتعدد الصفحات.
