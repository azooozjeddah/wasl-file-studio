...
- [ ] extract-pdf-pages فقط: تدقيق التنفيذ الحالي في ToolWorkspace وpdf-engine وتحديد العيب وخطة الإصلاح قبل أي تعديل.
- [ ] extract-pdf-pages فقط: حفظ نقطة رجوع ثم تنفيذ إصلاح محصور واختباره على صفحات متتالية وغير متتالية وPDF عربي وصوري متعدد الصفحات.
- [ ] extract-pdf-pages فقط: فحص المخرجات والبناء والـdiff وحفظ المرحلة مع بقاء Lifecycle Disabled ومن دون نشر Production.
