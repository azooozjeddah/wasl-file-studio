...
- [x] توحيد تأثير خلفية الهيدر العلوي والسفلي بنفس البنفسجي والشفافية وbackdrop-blur، مع Safety Check ونشر واحد فقط بعد الموافقة.
- [x] إنشاء والتحقق من checkpoint احتياطي لمصدر المشروع والإعدادات غير الحساسة فقط، مع استبعاد محتوى المستخدم وقاعدة البيانات والأسرار.
- [x] فحص Push من local main إلى github/main قراءةً فقط عبر علاقة السلف وgit push --dry-run دون تنفيذ Push.
- [x] تنفيذ Push fast-forward من local main إلى github/main فقط والتحقق من تطابق SHA، دون staging أو commit لـtodo.md ودون نشر.
- [x] نشر النسخة المتزامنة من main عند ae58be6 والتحقق من الرابط والـSHA والتحذيرات دون عمليات Git إضافية.
- [ ] تشخيص مصدر HTTP 503 للمسارات غير الموجودة في Production قراءةً فقط دون تعديل أو build أو نشر.
- [x] إصلاح SEO title إلى العنوان المعتمد وإضافة ALT وصفي للصورتين دون تغيير التصميم أو الوظائف أو metadata الأخرى.
- [x] إنشاء Commit محلي انتقائي لتعديلات SEO في الملفات الثلاثة فقط، مع استبعاد todo.md ودون Push أو نشر.
