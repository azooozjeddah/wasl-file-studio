...
export default function ToolsIndexPage() {
  ...
  const lifecycleBySlug = new Map((catalog.data ?? []).map((tool: { slug: string; lifecycleStatus?: "ready" | "beta" | "maintenance" | "disabled" }) => [tool.slug, tool.lifecycleStatus]));
